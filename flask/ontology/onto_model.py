...
onto_path.append('.')
onto = get_ontology('http://127.0.0.1:8000/umwelt.owl')
...
with onto:
    ...
    class has_topic(ObjectProperty):
        domain = [Pub]
        range = [Topic]
    class has_file_CID(ObjectProperty):
        domain = [Pub]
        range = [CID]
    class has_json_CID(ObjectProperty):
        domain = [Pub]
        range = [CID]
...
onto.save()
onto.save(file = "umwelt.owl", format = "rdfxml")